...
class UnionFind {
 ...
 //Obj_1 comes first
  ...
  friend std::ostream& operator<<(std::ostream&, const UnionFind<K, D, E>&);
...
//Errors
  ...
  std::ostream& operator<<(std::ostream& os, UnionFind<int, D, E>& obj)
  {
